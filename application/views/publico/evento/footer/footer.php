...
<!-- END FOOTER -->
	...
	<script src="<?php echo load_myscript($assets_admin_pages_myscripts, $privilegios, $controlador, 'form-inscripcion') ?>" type="text/javascript"></script>
