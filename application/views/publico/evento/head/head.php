...
<head>
	...
	<!-- BEGIN PAGE STYLES -->
	<link href="<?php echo $assets_admin_pages ?>css/news.css" rel="stylesheet" type="text/css"/>
	<link href="<?php echo $assets_admin_pages ?>css/blog.css" rel="stylesheet" type="text/css"/>
	<!-- END PAGE STYLES -->

	<!-- BEGIN THEME STYLES -->
	<!-- DOC: To use 'rounded corners' style just load 'components-rounded.css' stylesheet instead of 'components.css' in the below style tag -->
	<link href="<?php echo $assets_global_css ?>components-rounded.css" id="style_components" rel="stylesheet" type="text/css">
	<link href="<?php echo $assets_global_css ?>plugins.css" rel="stylesheet" type="text/css">
	<link href="<?php echo $assets_admin_layout3 ?>css/layout.css" rel="stylesheet" type="text/css">
	<link href="<?php echo $assets_admin_layout3 ?>css/themes/default.css" rel="stylesheet" type="text/css" id="style_color">
	<link href="<?php echo $assets_admin_layout3 ?>css/custom.css" rel="stylesheet" type="text/css">
	<!-- END THEME STYLES -->
