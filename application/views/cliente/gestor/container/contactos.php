							...
							<tbody>
								<?php foreach ($contactos_cliente as $contacto) : ?>
									<tr class="odd gradeX" id="<?php echo $contacto->id ?>">
										...
										<td width="1%"><a href="<?php echo site_url('gestionar/contactos/mostrar/'.$contacto->id) ?>" data-target="#ajax_form_contacto" data-toggle="modal" class="btn btn-circle blue btn-xs"><i class="fa fa-search-plus"></i> Ver/Editar</button></td>
		...
		<div class="modal-content">
			...
			<form id ="form-contacto-nuevo" method="post" accept-charset="utf-8">
				...
				<div class="modal-footer">
					...
					<button type="submit" id="btn_guardar_contacto" class="btn btn-circle green">Guardar</button>
				</div>
			</form>
		</div>
	</div>
