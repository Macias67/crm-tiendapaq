		...
		<!-- BEGIN FORM EDITAR INFORMACION -->
		<div id="editar-info" class="modal container fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
			<div class="modal-header">
				<h3 class="modal-title">
					<b>Actualizar Información - </b><small><?php echo $usuario_activo['razon_social'] ?></small>
				</h3>
			</div>
									...
									<div class="col-md-8">
										<div class="input-icon">
											...
											<select class="form-control" name="estado">
												<option value="Aguascalientes" <?php echo ($usuario_activo['estado']=="Aguascalientes")? "selected":"" ?>>Aguascalientes</option>
												...
												<option value="Oaxaca" <?php echo ($usuario_activo['estado']=="Oaxaca")? "selected":""?>>Oaxaca</option>
