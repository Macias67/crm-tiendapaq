			...
			<div class="col-md-12">
				...
				<!-- BEGIN Portlet PORTLET-->
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<span class="caption-subject bold uppercase"><i class="fa fa-desktop"></i> Sistemas registrados</span>
							</div>
							<div class="actions">
				...
				<div class="col-md-6">
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<span class="caption-subject bold uppercase"><i class="fa fa-list"></i> Versiones de los sistemas</span>
							</div>
							<div class="actions">
								<div class="btn-group pull-right">
									<button id="tabla_sistemas_editable_new" class="btn btn-circle green btn-xs">
