...
<div class="modal-body container">
	<form id ="form-contacto" class="form-horizontal" method="post" accept-charset="utf-8">
		<!-- DIV ERROR -->
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<div class="input-icon">
							...
							<input type="text" class="form-control" placeholder="Teléfono" name="telefono_contacto" value="<?php echo $contacto->telefono_contacto ?>">
						</div>
					</div>
				</div>
				<!-- Puesto -->
