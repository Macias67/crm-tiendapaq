								...
								<table class="row note">
									<tr>
										<td class="wrapper last">
											...
											<?php if (isset($recordar)): ?>
												<h3 style="font-size: 20px;display: block;margin: 5px 0 15px 0;color:#EE0014"><b>Le recordamos que estamos a poco tiempo de iniciar el curso.</b></h3>
											<?php endif ?>
