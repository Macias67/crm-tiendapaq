								...
								<table class="row note">
									<tr>
										<td class="wrapper last">
											...
											<p> Le notificamos que su caso quedó terminado, para dar por cerrado su caso le pedimos de favor que conteste este cuestionario.</p>
											<!-- BEGIN: Note Panel -->
											<table class="twelve columns" style="margin-bottom: 10px">
												<tr>
													<td class="panel" style="background: #ECF8FF;border: 0;padding: 10px !important;">
														<b>Link encuesta:</b> <a href="<?php echo $url_encuesta ?>"><?php echo $url_encuesta ?></a>
													</td>
												</tr>
												<tr>
													<td class="panel" style="background: #ECF8FF;border: 0;padding: 10px !important;">
											...
											<p> Con esta información nos ayudarás a saber tu opinión y a mejorar nuestra aplicación y servicios. </p>
