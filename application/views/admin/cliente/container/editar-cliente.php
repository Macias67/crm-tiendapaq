										...
										<tbody>
											<?php foreach ($equipos as $equipo) : ?>
												<tr id="<?php echo $equipo->id ?>">
													...
													<td width="1%"><a href="<?php echo site_url('cliente/equipos/mostrar/'.$equipo->id) ?>" data-target="#ajax_form_equipo" data-toggle="modal" class="btn btn-circle blue btn-xs"><i class="fa fa-search"></i> Ver/Editar</button></td>
