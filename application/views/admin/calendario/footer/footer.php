	...
	<script src="<?php echo $assets_global_plugins ?>fullcalendar/lib/moment.min.js"></script>
	<script src="<?php echo $assets_global_plugins ?>fullcalendar/fullcalendar/fullcalendar.min.js"></script>
	...
	<script src="<?php echo load_myscript($assets_admin_pages_myscripts, $privilegios, $controlador, 'calendar') ?>" type="text/javascript"></script>
	<script>
