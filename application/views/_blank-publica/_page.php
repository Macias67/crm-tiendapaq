					...
					<div class="portlet light ">
						...
						<div class="portlet-body">
							...
							<div class="table-scrollable table-scrollable-borderless">
								...
								<tr>
									<td class="fit">
										<img class="user-pic" src="<?php echo $assets_admin_layout3 ?>img/avatar4.jpg">
									</td>
									<td>
								...
								<tr>
									<td class="fit">
										<img class="user-pic" src="<?php echo $assets_admin_layout3 ?>img/avatar5.jpg">
									</td>
									<td>
								...
								<tr>
									<td class="fit">
										<img class="user-pic" src="<?php echo $assets_admin_layout3 ?>img/avatar6.jpg">
									</td>
									<td>
								...
								<tr>
									<td class="fit">
										<img class="user-pic" src="<?php echo $assets_admin_layout3 ?>img/avatar7.jpg">
									</td>
									<td>
