		...
		<div class="container">
			...
			<div class="hor-menu ">
				<ul class="nav navbar-nav">
					<li class="active">
						<a href="<?php echo base_url('/cursos'); ?>">Inicio</a>
					</li>
...
<!-- 						<ul class="dropdown-menu">
					...
					<li class="menu-dropdown">
						<a href="#" target="" class="tooltips" data-container="body" data-placement="bottom" data-html="true" data-original-title="AngularJS version demo">
						AngularJS Version </a>
					</li>
				</ul>
			</div>
