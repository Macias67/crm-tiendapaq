...
class MY_Form_validation extends CI_Form_validation {
	...
	*/
	function file_allowed_type($file,$type)
	{
		...
		if(!in_array($file_ext,$exts)) {
			$this->set_message('file_allowed_type',"%s debe ser $type.");
			return false;
		} else {
			return TRUE;
		}
	...
	*/
	function file_image_maxdim($file,$dim)
	{
		...
		$this->set_message('file_image_maxdim','%s imagen es muy grande (Dimenciones).');
		return FALSE;
	}
	...
	*/
	function file_image_mindim($file,$dim)
	{
		...
		$this->set_message('file_image_mindim','%s es muy pequeño (Dimenciones).');
		return FALSE;
	}
